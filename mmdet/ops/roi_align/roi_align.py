...
class _ROIAlign(Function):
    ...
    def forward(ctx, input, roi, output_size, spatial_scale, sampling_ratio, aligned):
        ...
        ctx.aligned = aligned
        output = roi_align_cuda.roi_align_forward(
...
class RoIAlign(nn.Module):
    def __init__(self, out_size, spatial_scale, sampling_ratio=0, aligned=True):
        """
        Args:
            out_size (tuple): h, w
    ...
    def forward(self, input, rois):
        ...
        return roi_align(
            input, rois, self.out_size, self.spatial_scale, self.sampling_ratio, self.aligned
        )
